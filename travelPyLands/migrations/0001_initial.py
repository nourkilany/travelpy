    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel_rate', models.DecimalField(blank=True, decimal_places=10, max_digits=11, null=True)),
                ('hotel_low_image', models.CharField(blank=True, max_length=400, null=True)),
                ('hotel_high_image', models.CharField(blank=True, max_length=400, null=True)),
